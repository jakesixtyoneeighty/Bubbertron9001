...
/** A small synchronous SHA-256 implementation so manifests hash identically in
 * browsers, tests, and Tauri without relying on environment-specific crypto APIs. */
